...
**Three-property architecture (DECIDED July 2026).** The `gold-domains` turborepo (goldbuyer.io, goldtobtc.com, goldvsbitcoin.org) is restructured:
1. **offrampgold.com** — the brand, the funnel, all authority. Brand name locked: **Offramp** (final; trademark knockout search still required before M1).
2. **goldvsbitcoin.org** — Lane 2 editorial front door: merits/differences hub for buy/sell deciders. Opinionated, sourced, syndicates the daily ratio data; every conversion path points at offrampgold.com.
3. **goldbuyer.io — Phase 2 (month 4+): independent-style ranking site** à la proofofcustody.io — scores every online gold buyer (payout rates, insurance, proof, speed) against a published methodology; Offramp earns its ranking transparently. Targets "best place to sell gold" (3,600/mo) + "best place to sell gold near me" (2,400/mo). **Non-negotiable: FTC-compliant disclosure** in the footer of every page: "goldbuyer.io is operated by the team behind Offramp; all scores follow the public methodology." Done right, the disclosure is the differentiator.
4. **goldtobtc.com** — 301 entirely into offrampgold.com/gold-to-bitcoin whenever convenient.
...
| Vault (owner) | Cash out — get a free kit | Invite family |
| Price alert | Your vault is up — cash out at today's prices | See my vault |
| Offer acceptance | Accept and cash out | Free return instead |
| Thesis pages | Check your gold in 60 seconds | Read the methodology |

**The "Cash out" verb rule:** "Cash out" is the product's decision-moment verb, never the company name and never first-contact copy. It appears ONLY after the user has signaled intent to sell: vault sell CTA, price-alert CTAs, offer acceptance, and Lane 2 campaign copy ("cash out of gold, into bitcoin"). It never appears on the homepage hero, estimate landing, or any surface a guilt-stage inheritor sees first — there, the language stays "see what it's worth / when everyone's ready."
...
## 18. Decisions locked + defaults

**Locked (do not revisit):** Brand = **Offramp**, domain offrampgold.com ("Cash Out" rejected as company name — casino register fights the heirloom customer, cash-for-gold pattern-match, Cash App/betting findability pollution; it survives as the product's decision-moment verb per §4). Three-property architecture per §3. Family Vault as core feature; Heirfolo reserved as future spinoff brand.

**Defaults (overrule anytime):** Google + magic link only at launch (no Facebook; Apple with native app) · newsletter "The Family Ledger" · Austin = appointment-only claims until space exists · BTC bonus 1.5% pending Onramp agreement · Cormorant retained as display serif · payout rate 82%.
