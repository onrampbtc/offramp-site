...
export default function GoldToBitcoinLayout({
  ...
  return (
    <>
      ...
      <FAQJsonLd
        questions={[
          { question: "Can I sell gold for Bitcoin?", answer: "Yes. Offramp lets you sell physical gold and receive payment in Bitcoin. Your gold is assayed via professional assay testing, and the USD payout is converted to BTC through Onramp custody at current market rates." },
          { question: "How does gold to Bitcoin conversion work?", answer: "Ship your gold to Offramp using a free insured kit. After professional assay, accept your offer and choose Bitcoin as your payment method. The USD value is converted to BTC at the current spot price and sent to your Onramp account." },
