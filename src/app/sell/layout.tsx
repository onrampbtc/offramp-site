...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Sell your gold jewelry, coins, bullion, and scrap gold online. Free insured shipping, assay on camera, wire payment in 48 hours.",
    type: "website",
    locale: "en_US",
    siteName: "Offramp",
  ...
  return (
    <>
      ...
      <HowToJsonLd
        ...
        description="Sell your gold for cash or Bitcoin in 3 simple steps with free insured shipping and transparent professional assay."
        steps={[
          ...
          { name: "Get Paid", text: "We assay your gold with an precision assay equipment under video. Accept your offer and receive payment via wire transfer or Bitcoin within 48 hours." },
        ]}
      />
      <FAQJsonLd
        questions={[
          ...
          { question: "How long does the process take?", answer: "From the time we receive your gold, we complete professional assay and send your offer within 24 hours. Once you accept, payment is sent within 48 hours via wire transfer or Bitcoin." },
