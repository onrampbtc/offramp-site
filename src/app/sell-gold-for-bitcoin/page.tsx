...
export default function SellGoldForBitcoinPage() {
  return (
    <main className="min-h-screen bg-bg text-cream font-body">
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center animate-fade-in-up">
          ...
          <p className="text-lg md:text-xl text-cream-60 max-w-2xl mx-auto mb-10 leading-relaxed">
            Convert your physical gold into Bitcoin — the hardest money ever created.
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-cream-60 leading-relaxed">
                <strong className="text-cream">Yes, you can sell gold for Bitcoin.</strong>{" "}
                Offramp is the first gold buyer built for the Bitcoin economy. Ship your gold
                (jewelry, coins, bullion, dental, or scrap) using our free insured kit. We assay
                it with an XRF spectrometer under video, then pay you in Bitcoin through Onramp
                custody — typically within 48 hours. You get 80%+ of melt value, far more than
                pawn shops or most online buyers.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {[
            {
              icon: Lock,
              title: "Same Scarcity, Digital Form",
              description:
                "Gold is scarce. Bitcoin is scarcer — capped at 21 million forever. Both are hard money outside the fiat system, but Bitcoin exists in digital form.",
            },
            {
              icon: Zap,
              title: "Instant Portability",
              description:
                "Move $1M in gold and you need armored transport. Move $1M in Bitcoin and you need a phone. Cross any border, anytime, with zero friction.",
            },
            {
              icon: CheckCircle2,
              title: "Perfect Verifiability",
              description:
                "Gold requires XRF assay to verify. Bitcoin is verified by every node on the network — mathematically certain, no trust required.",
            },
            {
              icon: TrendingUp,
              title: "Superior Performance",
              description:
                "Bitcoin has outperformed every asset class over any 4-year period in its history. Gold preserves wealth. Bitcoin grows it.",
            },
          ...
          {[
            {
              icon: Gem,
              title: "Jewelry",
              items: "Rings, chains, bracelets, watches, broken pieces",
              link: "/sell-jewelry",
            },
            {
              icon: Coins,
              title: "Coins & Bullion",
              items: "Eagles, Krugerrands, Maple Leafs, bars, rounds",
              link: "/sell-coins",
            },
            {
              icon: Flame,
              title: "Dental Gold",
              items: "Crowns, bridges, inlays — any dental restoration",
              link: "/sell-dental-gold",
            },
            {
            ...
            },
            {
              ...
              items: "Inherited jewelry, mixed lots, entire collections",
              link: "/sell",
            },
            {
              icon: Bitcoin,
              title: "Any Karat for BTC",
              items: "10K, 14K, 18K, 22K, 24K — all paid in Bitcoin",
              link: "/gold-to-bitcoin",
            },
          ].map(({ icon: Icon, title, items, link }) => (
            <Link
              key={title}
              href={link}
              className="group bg-bg-card border border-cream-08 rounded-xl p-6 hover:border-gold-500/20 transition-all duration-300"
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-light">
            More Gold Value, Paid in Bitcoin
          </h2>
        </div>
        ...
        <p className="text-center text-cream-35 text-xs mt-4">
          Offramp is the only gold buyer offering Bitcoin payment through regulated custody.
        </p>
      </section>
          ...
          {[
            {
              ...
              description:
                "Request a free insured shipping kit with a prepaid USPS Priority Mail label and tamper-proof packaging. Delivered in 2–3 days.",
            },
            {
              step: "02",
              icon: FlaskConical,
              ...
              description:
                "Your gold is tested with an XRF spectrometer — the same technology used by refineries. The entire process is recorded on video for transparency.",
            },
            {
              step: "03",
              icon: Bitcoin,
              ...
              description:
                "Accept your offer and receive BTC through Onramp custody within 48 hours. Or choose USD wire — the choice is yours.",
            },
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        <div className="border-gold-gradient rounded-2xl p-8 md:p-10 text-center">
          <h2 className="font-display text-2xl md:text-3xl font-light mb-4">
            Questions About Selling Gold for Bitcoin?
          </h2>
          <p className="text-cream-60 mb-8 max-w-xl mx-auto">
            Our team understands both gold and Bitcoin. We&apos;ll walk you through the process,
            explain how Onramp custody works, and help you get the best value for your gold.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
          ...
          {[
            {
              ...
              description: "See how much BTC your gold is worth at current spot prices.",
              href: "/gold-to-bitcoin",
            },
            {
              title: "How It Works",
            ...
            },
            {
              ...
              description: "Compare these two hard money assets side by side.",
              href: "/guide/gold-vs-bitcoin-investment",
            },
            {
              title: "Sell Gold Coins for Bitcoin",
              description: "Convert American Eagles, Krugerrands, and more to BTC.",
              href: "/sell-gold-coins-for-bitcoin",
            },
            {
              title: "Live Gold Price",
              description: "Track the real-time gold spot price and market trends.",
              href: "/gold-price",
            },
            {
