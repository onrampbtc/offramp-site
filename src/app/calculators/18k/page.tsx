...
export default function EighteenKaratCalculator() {
  ...
  const pricePerGram18K = pricePerGramPure * PURITY;

  const results = useMemo(() => {
    const grams = unit === "oz" ? weightNum * GRAMS_PER_OZ : weightNum;
    const meltValue = grams * pricePerGram18K;
  ...
  }, [weightNum, unit, pricePerGram18K, btcPrice]);
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 pt-28 pb-20">
        ...
        <div className="text-center mb-12 animate-fade-in-up">
          ...
          <p className="text-cream-45 font-body text-lg max-w-2xl mx-auto">
            ...
            {KARAT_LABEL} gold contains 75% pure gold.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="bg-bg rounded-xl p-5 border border-cream-08">
              ...
              <p className="text-cream-35 font-mono text-xs mt-1">
                {fmt(results.grams, 2)}g &times; {fmtUSD(pricePerGram18K)}/g
              </p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-cream-60 font-body leading-relaxed">
            <p>
              18K gold is the international standard for luxury jewelry, containing 75%
              pure gold alloyed with 25% other metals. It is the most common gold purity
              in European, Middle Eastern, and Asian jewelry markets.
            </p>
            <p>
              Prized for its rich, warm color that is closer to pure gold than 14K or 10K,
              18K gold strikes a balance between beauty and wearability. It is softer than
              lower-karat gold, making it the preferred choice for high-end designer
              jewelry, fine watches, and heirloom pieces.
            </p>
            <p>
              When selling 18K gold, you benefit from a higher gold content per gram. For
              every gram of 18K gold, 0.75 grams are pure gold. Offramp pays 80% or more
              of this melt value, significantly outperforming pawn shops (20-35%) and most
              local jewelers (40-60%).
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
            <div className="bg-bg rounded-xl p-4 border border-cream-08 text-center">
              <p className="text-gold-500 font-display text-2xl font-bold">75.0%</p>
              <p className="text-cream-45 font-body text-sm mt-1">Pure Gold Content</p>
            </div>
            <div className="bg-bg rounded-xl p-4 border border-cream-08 text-center">
              <p className="text-gold-500 font-display text-2xl font-bold">750</p>
              <p className="text-cream-45 font-body text-sm mt-1">Hallmark Stamp</p>
            </div>
            <div className="bg-bg rounded-xl p-4 border border-cream-08 text-center">
              <p className="text-gold-500 font-display text-2xl font-bold">EU</p>
              <p className="text-cream-45 font-body text-sm mt-1">European Standard</p>
            </div>
          </div>
        </div>
