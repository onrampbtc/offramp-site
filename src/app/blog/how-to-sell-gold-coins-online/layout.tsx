...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      <FAQJsonLd
        questions={[
          { question: "Where is the best place to sell gold coins online?", answer: "Online gold buyers that pay based on melt value plus any numismatic premium typically offer the best prices (85-97% of spot). Services like Offramp provide free insured shipping and professional testing. For rare or numismatic coins, specialized coin dealers or auction houses may pay a premium over melt value." },
